...
import 'package:dalelak/Screens/sebha/CONSTANTS.dart';
import 'package:dalelak/Screens/sebha/utils/animated_flip_counter.dart';
          ...
          children: <Widget>[
                          ...
                          return Builder(
                            builder: (BuildContext context) {
                              return Container(
                                  ...
                                  child: Image.asset('assuts/zikr/$i.png'));
                            },
                          );
                        }).toList(),
                      ),
            ...
            Expanded(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (_, __) {
                  return Image.asset(
                    'assuts/beads/bead-$_imageIndex.png',
                  );
                },
                itemCount: null,
              ),
